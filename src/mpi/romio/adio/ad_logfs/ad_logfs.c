...
struct ADIOI_Fns_struct ADIO_LOGFS_operations = {
    ...
    /* We might be able to rework LOGFS_Open to be more tolerant of the
     * "single process creates, everyone opens" case, but for now stick
     * with the unoptimized case.  The slave file system will likely be
     * optimized anyway
     */
